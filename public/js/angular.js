 ...
 * {@link angular.Object} for more information about.html Angular arrays.
 *
    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * For more about.html how to configure services, see
 ...
 * @module ng
 * @description
 * An object that contains information about.html the current AngularJS version. This object has the
    ...
    forEach(type.split(' '), function(type){
      ...
      if (!eventFns) {
        if (type == 'mouseenter' || type == 'mouseleave') {
          ...
          // Read about.html mouseenter and mouseleave:
...
var $AnimateProvider = ['$provide', function($provide) {
  ...
  this.$get = ['$timeout', '$$asyncCallback', function($timeout, $$asyncCallback) {
     ...
     *
     * To learn more about.html enabling animation support, click here to visit the {@link ngAnimate
...
function $CacheFactoryProvider() {
   ...
   *
   * @description
   * Get information about.html all the caches that have been created
   *
...
function $CompileProvider($provide, $$sanitizeUriProvider) {
   ...
   *
   * Any url about.html to be assigned to a[href] via data-binding is first normalized and turned into
   ...
   * The sanitization is a security measure aimed at prevent XSS attacks via html links.
   *
   * Any url about.html to be assigned to img[src] via data-binding is first normalized and turned into
    ...
    function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn,
      ...
      for(var i = 0, ii = directives.length; i < ii; i++) {
        ...
        if (directiveValue = directive.transclude) {
          ...
          // Special case ngIf and ngRepeat so that we don't complain about.html duplicate transclusion.
 ...
 * @param {string=} cause optional information about.html the context in which
...
function $InterpolateProvider() {
  ...
  this.$get = ['$parse', '$exceptionHandler', '$sce', function($parse, $exceptionHandler, $sce) {
    ...
    function $interpolate(text, mustHaveExpression, trustedContext) {
      ...
      // Concatenating expressions makes it hard to reason about.html whether some combination of
...
function $LocationProvider(){
   ...
   * details about.html event object. Upon successful change
...
function $ParseProvider() {
   ...
   * **Warning Logs**
   *
   * If the unwrapping is enabled, Angular will log a warning about.html each expression that unwraps a
...
function qFactory(nextTick, exceptionHandler) {
   ...
   * a promise chain, you don't need to worry about.html it.
   *
 ...
 *
 * For the general details about.html this service in Angular, read the main page for {@link ng.$sce
 ...
 *
 * Read more about.html {@link ng.$sce Strict Contextual Escaping (SCE)}.
 */
...
// doesn't know about.html mocked locations and resolves URLs to the real document - which is
 ...
 *
 *
 * For more information about.html how angular filters work, and how to create your own filters, see
...
function textInputType(scope, element, attr, ctrl, $sniffer, $browser) {
  ...
  // More about.html composition events: https://developer.mozilla.org/en-US/docs/Web/API/CompositionEvent
  if (!$sniffer.android) {
    var composing = false;
        ...
        $scope.$watchCollection(rhs, function ngRepeatAction(collection){
          ...
          for (index = 0, length = collectionKeys.length; index < length; index++) {
            ...
            if (block.scope) {
              ...
              // new item which we don't know about.html
              childScope = $scope.$new();
            }
